...
def tree_importer(path,treename, n):
    ...
    mass_cut = "(LambdaCandidates_mass < 1.3) & (LambdaCandidates_mass > 1.07) &"
    ...
    data_reducing_cut = " (LambdaCandidates_p<20)  &   (LambdaCandidates_chi2geo<1000) &  (LambdaCandidates_chi2primpos<1e6) & (LambdaCandidates_chi2primneg < 3e7) &  (LambdaCandidates_ldl<5000) & (LambdaCandidates_chi2topo < 100000)"
